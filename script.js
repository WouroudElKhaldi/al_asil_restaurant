...
const menuData = [
    ...
    { cat: "علب نصف كيلو", items: [["حمص", 200000, "hommos.png"], ["فول", 200000, "foul_tahina.png"], ["مسبحة", 200000, "msabaha.png"]] },
    {
        cat: "معجنات", items: [
            ...
            ["بعلبكية", 400000, "man2oush_b3albakyeh.png"], ["سواري مشكل", 350000, "man2oush_sware_mshakal.png"], ["شامية", 600000, "man2oush_shamyeh.png"], ["لحم بعجين", 80000, "lahem_b_ajin.png"]
        ]
    },
    {
        cat: "عصائر", items: [
